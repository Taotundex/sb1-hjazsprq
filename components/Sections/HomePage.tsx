              ...
              <div className="md:mt-20 mt-10">
                ...
                <div className="flex flex-wrap md:gap-3 gap-2 space-x-0 space-y-0">
                  <Link href={'#electricity-sector'}>
                    <Button variant="outline" className="w-max flex items-center gap-2 justify-between md:px-3 px-2 md:h-10 h-10 border-[#DEDEDE] hover:bg-white/90 text-slate-700 rounded-full bg-transparent">
